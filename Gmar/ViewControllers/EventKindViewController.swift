...
class EventKindViewController: UIViewController {
    ...
    func initBtns(){
        basicEventBtn.layer.cornerRadius = basicEventBtn.layer.frame.width / 2
        developEventBtn.layer.cornerRadius = developEventBtn.layer.frame.width / 2
        familiyEventBtn.layer.cornerRadius = familiyEventBtn.layer.frame.width / 2
        generalEventBtn.layer.cornerRadius = generalEventBtn.layer.frame.width / 2
        futureAttEventBtn.layer.cornerRadius = futureAttEventBtn.layer.frame.width / 2
