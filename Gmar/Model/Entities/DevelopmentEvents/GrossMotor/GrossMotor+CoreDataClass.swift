//
//  GrossMotor+CoreDataClass.swift
//  Gmar
//
...
@objc(GrossMotor)
public class GrossMotor: DevelopmentalEvent {
    convenience init(type:String, month:String, eventType:Int16, eventDate:NSDate, child:Child?, staff:Staff?){
        self.init(entity: Model.instance.grossMotorEventEntity, insertInto: Model.instance.managedContext)
