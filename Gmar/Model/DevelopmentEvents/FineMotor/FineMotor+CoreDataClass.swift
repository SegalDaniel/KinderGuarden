...
@objc(FineMotor)
public class FineMotor: DevelopmentalEvent {
    convenience init(type:String, month:String, eventType:Int16, eventDate:NSDate, child:Child?, staff:Staff?){
        self.init(entity: Model.instance.fineMotorEventEntity, insertInto: Model.instance.managedContext)
