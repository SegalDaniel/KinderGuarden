...
class Utility{
    ...
    static func ourBtnDesign(title:String, radius:CGFloat, tag:Int, image:UIImage?, withBorder:Bool = false)->UIButton{
        ...
        btn.titleLabel?.contentMode = .scaleAspectFill
        ...
        if image != nil{
            ...
            btn.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: btn.titleLabel!.frame.size.height, right: 0)
        }
        if withBorder{
